   ...
   extends AbstractInstruction
{
   ...
   public DivideInstruction(String result, String ty, String op1, String op2)
   {
      this.result = result;
      this.ty = ty;
      this.op1 = op1;
   ...
   public void toARM(List<Instruction> arm, LinkedHashMap<String, Integer> stack) {
      ...
      if (!r1.contains("%")) {
         ...
         if (num > 256) {
            ...
            r1 = t1.getLabel();
            arm.add(new MovInstruction("r0", r1));
         }
         else {
            r1 = "#".concat(r1);
            arm.add(new MovInstruction("r0", r1));
         ...
         arm.add(new MovInstruction("r0", op1));
      }
      ...
      if (!r2.contains("%")) {
         ...
         if (num > 256) {
            ...
            r2 = t2.getLabel();
            arm.add(new MovInstruction("r1", r2));
         }
         else {
            r2 = "#".concat(r2);
            arm.add(new MovInstruction("r1", r2));
         ...
         arm.add(new MovInstruction("r1", op2));
      }

      arm.add(new BlInstruction("__aeabi_idiv"));
